            ...
            <section class="col-span-8 col-start-5 mt-10 space-y-6">
                @auth
                    <form action="/posts/{{ $post->slug }}/comment" method="POST"
                        ...
                        <div class="mt-5">
                            <textarea name="body" class="w-full text-sm" rows="5" placeholder="Think of something to say!"></textarea>
                        </div>
                ...
                @else
                <p class="font-semibold">Want to comment? <a class="hover:underline" href="/login">Login</a> or <a class="hover:underline" href="/register">Register</a>.</p>
                @endauth
