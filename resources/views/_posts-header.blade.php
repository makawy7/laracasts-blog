        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false" class="relative">
                <button @click="show = ! show"
                    ...
                    <svg class='transform -rotate-90 absolute pointer-events-none' width="22" height="22"
                        viewBox="0 0 22 22" style="right: 12px;">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50 overflow-auto max-h-52"
                    ...
                    focus:text-white {{ !isset($currentCategory) ? 'bg-blue-500 text-white' : '' }}"
                        href="/">
                        All
                    </a>
                    @foreach ($categories as $category)
                        <a class="block text-left px-3 text-sm leading-6 
                                hover:bg-blue-500 focus:bg-blue-500 hover:text-white 
                                focus:text-white {{ isset($currentCategory) && $currentCategory->is($category) ? 'bg-blue-500 text-white' : '' }}"
